...
std::string DataBase::findOne(const std::string type, std::string val, int index)
{
    try
    {
        ...
        {
            if(line.find(val) != std::string::npos) // ÔøΩÔøΩÔøΩœ¥ÔøΩ row √£ÔøΩÔøΩ
            {
...
// ÔøΩÔøΩ ÔøΩÔøΩÔøΩ‡ø° ÔøΩÔøΩÔøΩÔøΩ ÔøΩŒ±ÔøΩÔøΩÿºÔøΩ id pw ÔøΩÔøΩ id ÔøΩ÷¥ÔøΩÔøΩÔøΩ ÔøΩÔøΩ ÔøΩÔøΩ ÔøΩÔøΩÔøΩ…∑ÔøΩ db.FindOne("student", "exid2", 2) ÔøΩÔøΩ ÔøΩÔøΩÔøΩÃµÔøΩ ÔøΩÔøΩƒ°ÔøΩœ∞ÔøΩ, db.FindOne("student", "expass", 3) ÔøΩﬁæ∆ºÔøΩ »ÆÔøΩÔøΩ.
...
void DataBase::update(const std::string type, std::string primaryKey, std::string content, int index)
{
    try
    {
        std::string directory = findDB(type);
        std::ifstream fin(directory);
        std::ofstream fout("temp.txt");  // ÔøΩœΩÔøΩÔøΩÔøΩÔøΩÔøΩÔø?
        ...
        try
        {
            if (fin.is_open() && fout.is_open())
            {
                ...
                while (std::getline(fin, line))
                {
                    ...
                    if (words[0] == primaryKey) // ÔøΩÃ∞…∑ÔøΩ ÔøΩÔøΩÔøΩÃ∫ÔøΩ & row ÔøΩÔøΩÔøΩÔøΩ
                    {
                        // string ÔøΩÔøΩÔøΩÔøΩ
                        int i;
                        std::string newData = "";
                    ...
                    {
                        fout << line << "\n";  // ÔøΩÔøΩÔøΩ–ΩÔøΩ ÔøΩÔøΩÔøΩÔøΩ ÔøΩÔøΩÔøΩÔøΩ ÔøΩ÷±ÔøΩ
                    }
...
void DataBase::Delete(const std::string type, std::string lineToDelete) {
    ...
    // ?õêÎ≥? ?åå?ùº?ùò Í∞? Ï§ÑÏùÑ ?ûÑ?ãú ?åå?ùºÎ°? Î≥µÏÇ¨ (?Ç≠?†ú?ï† Ï§ÑÏ?? ?†ú?ô∏) // ?Ç≠?†ú?ï† Í≤ÉÎßå ?ì§?ó¨Î≥¥ÎÇ∏?ã§.
